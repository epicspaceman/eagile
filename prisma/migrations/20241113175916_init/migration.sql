...
INSERT INTO "new_Ticket" ("assigneeId", "authorId", "description", "epicId", "id", "status", "title") SELECT "assigneeId", "authorId", "description", "epicId", "id", "status", "title" FROM "Ticket";
DROP TABLE "Ticket";
